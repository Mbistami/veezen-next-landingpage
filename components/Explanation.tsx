...
export const Explanation = () => {
  return (
    <div className="w-full lg:h-screen text-black flex flex-col lg:flex-row bg-gradient-to-b from-[#9fc4d3] to-[#dcdddf] pb-20 border-t border-[#c7d5db] relative">
      ...
      <div className="w-full lg:w-1/2 flex flex-col px-8 pb-10 lg:pl-14 lg:pt-44 gap-10">
        <p className="text-[#0662a3] font-bold text-xl">NOTRE MISSION</p>
        <p className="text-xl lg:text-5xl font-nunito font-bold leading-relaxed">
          Votre épanouissement pour un meilleur engagement en entreprise.
        </p>
      </div>
      <div className="w-full lg:w-1/2 flex flex-col  justify-center font-nunito font-bold">
